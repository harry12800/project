package cn.harry12800.vchat.server.scanner;
				...
				if (methods != null && methods.length > 0) {
					for (Method method : methods) {
						...
						if (InvokerHoler.getInvoker(module, cmd) == null) {
							InvokerHoler.addInvoker(module, cmd, Invoker.valueOf(method, bean, desc));
							System.out.println("添加命令:" + "module:" + module + " " + "cmd：" + cmd +"："+desc);
						} else {
