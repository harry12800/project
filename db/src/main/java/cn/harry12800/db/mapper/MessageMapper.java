...
public interface MessageMapper { //extends CrudDao<Message> {
	...
	* 查询根据字段名称和数据
	**/
	List<Message> findByParam(@Param("propName") String propName,@Param("value") Object value);
	/**
	* 删除多行数据
	**/
	...
	* 查询多行数据
	**/
	List<Message> findByIds(Set<?> set);
	/**
	* 保存数据
	*/
	int save(Message t);
