...
public interface RoomMapper { //extends CrudDao<Room> {
	...
	* 查询根据字段名称和数据
	**/
	List<Room> findByParam(@Param("propName") String propName,@Param("value") Object value);
	/**
	* 删除多行数据
	**/
	List<Room> findAll();
